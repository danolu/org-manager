            ...
            <div class="card">
                ...
                <form action="{{ route('positions.update', $position) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror"
                                ...
                                <option value="single" {{ old('type', $position->type) === 'single' ? 'selected' : '' }}>
                                    Single Choice (Select one candidate from all)
                                </option>
                                <option value="multiple" {{ old('type', $position->type) === 'multiple' ? 'selected' : '' }}>
                                    Multiple Choice (Select up to maximum limit)
                                </option>
                                <option value="yes-no" {{ old('type', $position->type) === 'yes-no' ? 'selected' : '' }}>
                        ...
                        <div class="form-group" id="max_vote_group" style="display: {{ old('type', $position->type) === 'multiple' ? 'block' : 'none' }};">
                            ...
                            <input type="number"
                                   ...
                                   id="max_vote"
                                   name="max_vote"
                                   value="{{ old('max_vote', $position->max_vote ?? 2) }}"
                                   min="1"
                                   max="10">
                            @error('max_vote')
                                <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="category"
                                   name="category"
                                   value="{{ old('category', $position->category) }}"
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('positions.show', $position) }}" class="btn btn-secondary">
